...
public class EmailSender {
    ...
    private static final String CONFIRMATION_FIRST = "<!DOCTYPE html>"+
            "<html lang=\"en\" >"+
            "<head>"+
            "  <meta charset=\"UTF-8\">"+
            ...
            "                                                              <img alt=\"Logo\" title=\"\" height=\"auto\" src=\"https://i.ibb.co/9ZmN13v/Logo.png\""+
            ...
            "                                                        <p>Have we got the right email address to reach you on? "+
            "                                                        To confirm that you need to paste the code below inside the game dialog.</p>"+
            "                                                        <p>"+
            "                                                          <p class=\"btn\" mc:disable-tracking=\"\">";
    private static final String CONFIRMATION_SECOND = "</p>"+
            "                                                        </p>"+
            "                                                        <p>If you don’t know why you got this email, please tell us straight away so we can"+
            "                                                          fix this for you.</p>"+
            "                                                        <hr style=\"margin-top: 56px\">"+
            "                                                        <p class=\"mb-0\">Thanks,</p>"+
            "                                                        <p class=\"mb-0\">The TankWars Company</p>"+
            "                                                      </div>"+
            "                                                    </td>"+
            "                                                  </tr>"+
            "                                                </tbody>"+
    ...
    public static void init(String email, String password) throws MessagingException {
        ...
        System.out.println("Successfully connected to Gmail SMTP");
    }

    public static void sendConfirmationCode(String destinationEmail, String code){
        new Thread(() -> {
            MimeMessage message = new MimeMessage(session);
            try {
                InternetAddress from = new InternetAddress(session.getProperty("mail.smtp.user"),
                        "TankWars");
                message.setFrom(from);
                message.setSender(from);
                message.setSubject("Email confirmation");
                message.addRecipients(Message.RecipientType.TO, InternetAddress.parse(destinationEmail));

                Multipart multipart = new MimeMultipart("alternative");
                BodyPart messageBodyPart = new MimeBodyPart();
                messageBodyPart.setContent(CONFIRMATION_FIRST + code + CONFIRMATION_SECOND,
